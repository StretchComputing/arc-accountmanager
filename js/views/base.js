var EXELON = (function (r, $) {
  ...
  r.JqmPageBaseView = Backbone.View.extend({
    constructor: function () {
      try {
        RSKYBOX.log.info('entering', 'JqmPageBaseView.constructor');
        ...
        RSKYBOX.log.error(e, 'JqmPageBaseView.constructor');
      }
    },
    ...
    getHeader: function () {
      try {
        ...
        RSKYBOX.log.error(e, 'JqmPageBaseView.getHeader');
      }
    },
    getContent: function () {
      try {
        ...
        RSKYBOX.log.error(e, 'JqmPageBaseView.getContent');
      }
    },
    getFooter: function () {
      try {
        ...
        RSKYBOX.log.error(e, 'JqmPageBaseView');
      }
    },
    ...
    updateApplicationName: function () {
      try {
        var app;
        RSKYBOX.log.info('entering', 'JqmPageBaseView.updateApplicationName');
        ...
        RSKYBOX.log.error(e, 'JqmPageBaseView.updateApplicationName');
      }
    },
    ...
    appLink: function (clazz, name) {
      try {
        ...
        RSKYBOX.log.error(e, 'JqmPageBaseView.appLink');
      }
    },
    ...
    renderStatusButton: function (pageLink) {
      try {
        ...
        RSKYBOX.log.error(e, 'JqmPageBaseView.renderStatusButton');
      }
    },
    ...
    changeStatus: function () {
      try {
        ...
        case 'closed':
          ...
          break;
        default:
          RSKYBOX.log.warn('Invalid status for: ' + this.model.get('id'), 'View.changeStatus');
          break;
        }
        ...
        RSKYBOX.log.error(e, 'JqmPageBaseView.changeStatus');
      }
    },
  });
